...
$router->group(['prefix' => 'api/v1'], function () use ($router) {
  ...
  $router->post('anime/{id}/episode/{ep}/restore', 'EpisodeController@restore');
  ...
  $router->post('genre/{id}/restore', 'GenreController@restore');
  ...
  $router->post('licensor/{id}/restore', 'LicensorController@restore');
  ...
  $router->post('produser/{id}/restore', 'ProduserController@restore');
